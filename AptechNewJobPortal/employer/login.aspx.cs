    ...
    public partial class login : System.Web.UI.Page
    {
        ...
        protected void btn_login_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SqlCommand command = new SqlCommand("sp_select_login_employer", connection);
        ...
        protected void btn_register_redirect_Click(object sender, EventArgs e)
        {
            Response.Redirect("/employer/registration.aspx");
        }
    }
}