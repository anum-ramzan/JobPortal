...
namespace AptechNewJobPortal.employer
{
    public partial class company : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int count = MethodReusability.ReturnSingleIntValue("sp_select_company_count", "@uid", Session["UserId"].ToString());

            MethodReusability.DropDown(ddl_cindustry, "tbl_industry", "industry_id", "industry_name", "Industry");
        }

        protected void btn_UpdateCompanyAdd_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        protected void btn_UpdateCompanyClose_Click(object sender, EventArgs e)
        {
