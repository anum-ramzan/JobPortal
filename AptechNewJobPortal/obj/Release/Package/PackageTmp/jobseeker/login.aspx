<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="AptechNewJobPortal.jobseeker.login" %>
            ...
            <div class="row">
                <div class="col-sm-4 col-sm-offset-4 login">
                    <h3 class="text-center text-bold login-h3">
                        <img src="/Images/jobseeker.png" class="login-image" />Job Seeker Login</h3>
                    <div class="row">
                        <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <asp:Button ID="btn_register" runat="server" Text="Register Now" CssClass="btn btn-block same-button btn-login login-in-register btn-yellow" OnClick="btn_register_Click" />
                        </div>
                    </div>
